...
def test_plex_database_direct():
    ...
    # Ruta de la BBDD en tu Synology
    db_path = r"\\DiskStation\docker\plex\Library\Application Support\Plex Media Server\Plug-in Support\Databases\com.plexapp.plugins.library.db"
