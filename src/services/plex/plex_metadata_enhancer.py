# -*- coding: utf-8 -*-
"""
Enhancer de metadatos usando PLEX API
Añade información de PLEX a los duplicados encontrados
"""
...
class PlexMetadataEnhancer:
    """Añade metadatos de PLEX a los duplicados encontrados"""
...
def enhance_duplicates_with_plex(duplicate_groups: List[List[Dict[str, Any]]], 
    ...
    """
    enhancer = PlexMetadataEnhancer(server_url, token)
...
if __name__ == "__main__":
    ...
    server_url = "http://DiskStation:32400"
    token = "your_token_here"
    
    enhanced = enhance_duplicates_with_plex(test_groups, server_url, token)
