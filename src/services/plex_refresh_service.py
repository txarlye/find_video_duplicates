...
class PlexRefreshService:
    ...
    def refresh_library_by_id(self, library_id: int) -> bool:
        """
        Refresca una biblioteca específica por ID
        ...
        try:
            ...
            # Actualizar el timestamp de la biblioteca para forzar refresh
            sql = """
            ...
            self.logger.info(f"Biblioteca {library_id} marcada para refresh")
            return True
            
        except Exception as e:
            self.logger.error(f"Error refrescando biblioteca {library_id}: {e}")
            return False
    
    def refresh_library_by_name(self, library_name: str) -> bool:
        """
        Refresca una biblioteca específica por nombre
        ...
        try:
            ...
            sql = "SELECT id FROM library_sections WHERE name = ?"
            ...
            # Refrescar por ID
            return self.refresh_library_by_id(library_id)
            
        except Exception as e:
            self.logger.error(f"Error refrescando biblioteca '{library_name}': {e}")
            return False
    
    def refresh_all_libraries(self) -> bool:
        """
        Refresca todas las bibliotecas
        ...
        try:
            ...
            # Actualizar timestamp de todas las bibliotecas
            sql = """
            UPDATE library_sections 
            SET updated_at = strftime('%s', 'now')
            """
            ...
            self.logger.info("Todas las bibliotecas marcadas para refresh")
            return True
            
        except Exception as e:
            self.logger.error(f"Error refrescando todas las bibliotecas: {e}")
            return False
