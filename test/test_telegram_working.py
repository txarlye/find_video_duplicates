#!/usr/bin/env python3
"""
Script que funciona basado en test_telegram_direct.py
Arregla el problema de los videos 2 y 3
"""
...
async def upload_video_async(video_path, video_name, video_title, video_year=None):
    """Sube un video usando Telethon - VERSIÓN QUE FUNCIONA"""
    print(f"\n{'='*60}")
...
def main():
    """Función principal"""
    print("🚀 Script Telethon que FUNCIONA")
    print("="*50)
