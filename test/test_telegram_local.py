...
# -*- coding: utf-8 -*-
"""
Script de prueba usando TelegramServiceLocal (inspirado en Tanpachiro-bot)
"""
...
from src.services.telegram_service_local import TelegramServiceLocal

def test_video_upload(video_path: str, video_name: str, video_title: str, video_year: str = None) -> bool:
    """Prueba la subida de un video usando el servicio local"""
    print(f"\n{'='*60}")
    ...
    # Crear servicio
    telegram_service = TelegramServiceLocal()
    ...
    print("📤 Intentando subir video como documento...")
...
def main():
    ...
    print("🚀 Script de Test con TelegramServiceLocal (Tanpachiro-bot style)")
    print("=" * 70)
    ...
    print(f"   Servidor Local: {'✅ Configurado' if settings.get('telegram.local_server') else '❌ Usando API pública'}")
