...
# -*- coding: utf-8 -*-
"""
Script de prueba usando el nuevo TelegramServiceV2
"""
...
from src.services.telegram_service_v2 import TelegramServiceV2

def test_video_upload(video_path: str, video_name: str, video_title: str, video_year: str = None) -> bool:
    """Prueba la subida de un video usando el nuevo servicio"""
    print(f"\n{'='*60}")
    ...
    # Crear servicio
    telegram_service = TelegramServiceV2()
...
def main():
    ...
    print("🚀 Script de Test con TelegramServiceV2")
    print("=" * 60)
